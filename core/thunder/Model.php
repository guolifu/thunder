...
class Model extends Medoo{
    ...
    public function all(){
        ...
        if(empty($this->join)){
            ...
            $res = $this->select($this->name,$join=$this->join,$field,$where);
        }
        return $res ;
    }
    /**
    ...
    {
        return parent::update($this->name, $data, [
            'id' => $id
        ]);
    }
    ...
    public function getLastId(){
        return parent::max($this->name,'id');
    }

    public function getFirstId(){
        return parent::min($this->name,'id');
    }
    ...
    {
        return parent::update($this->name, $data, $this->where); // TODO: Change the autogenerated stub
    }

    public function max($table=null, $join=null, $column = null, $where = null)
    {
        return parent::max($this->name, $this->field, $this->where); // TODO: Change the autogenerated stub
    }

    public function min($table=null, $join=null, $column = null, $where = null)
    {
        return parent::min($this->name,$this->field, $this->where); // TODO: Change the autogenerated stub
    }

    public function avg($table=null, $join=null, $column = null, $where = null)
    {
        return parent::avg($this->name,$this->field, $this->where); // TODO: Change the autogenerated stub
    }

    public function sum($table=null, $join=null, $column = null, $where = null)
    {
        return parent::sum($this->name,$this->field, $this->where); // TODO: Change the autogenerated stub
    }
